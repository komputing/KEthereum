...
class TheRLPEncoder {
    ...
    fun encodingWorks() {
        ...
        assertThat(0.toRLP().encode()).isEqualTo("00".hexToByteArray())
        ...
        assertThat(RLPList(listOf(0.toRLP())).encode()).isEqualTo("c100".hexToByteArray())
        assertThat(RLPList(listOf(1.toRLP())).encode()).isEqualTo("c101".hexToByteArray())
