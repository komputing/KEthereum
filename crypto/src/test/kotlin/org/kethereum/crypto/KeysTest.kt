...
class KeysTest {
    ...
    fun testGetAddressString() {
        assertThat(PublicKey(PUBLIC_KEY_STRING).toAddress()).isEqualTo(ADDRESS_NO_PREFIX)
    }
    ...
    fun testGetAddressZeroPaddedAddress() {
        ...
        assertThat(publicKey.toAddress()).isEqualTo("01c52b08330e05d731e38c856c1043288f7d9744")
    }

    @Test
    fun testGetAddressBigInteger() {
        assertThat(PUBLIC_KEY.toAddress()).isEqualTo(ADDRESS_NO_PREFIX)
    }
